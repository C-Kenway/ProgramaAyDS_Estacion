...
int main()
{
    ...
    do{
    	printf("\n------------------------------------------------------------------------------------------------------------------\n");
    	printf("\t SISTEMA DE GESTION PARA UN ESTACIONAMIENTO");
    	printf("\n------------------------------------------------------------------------------------------------------------------\n");
        ...
        cout << "e. Registro de nuevo usuario " << endl;
        
        printf("\n\nNOTA: Recuerdea actualizar despues de cualquier actualizacion a la BD\n");
        cout << "f. Actualizar" << endl;
		cout << "g. Salir " << endl << endl;
        do{
            cout << "Que opcion quieres hacer?: ";
            cin >> cOpcion;
            cOpcion = tolower(cOpcion);
        }while(cOpcion != 'a' && cOpcion != 'b' && cOpcion != 'c' && cOpcion != 'd' && cOpcion!='e' && cOpcion != 'f' && cOpcion != 'g');
        system("cls");
        switch(cOpcion)
        {
		...
		case 'e': //Opcion para registrar los auto
			system("cls");
			
			FILE *archivo;
			archivo = fopen ("tarjetas.txt","a+");
			
			if (!(archivo)) /* otra forma de controlar si se produce un error */
			{
        	...
        	cout << "p. Proveedor " << endl << endl;
        		do{
            		cout << "Que tipo de usuario se registra? : ";
            		cin >> cUsuario;
            		cUsuario = tolower(cUsuario);
        		}while(cUsuario != 'c' && cUsuario!='e' && cUsuario != 'p');
			system("cls");
			switch(cUsuario){
				case 'c':
				...
				case 'e':
					...
					break;
				case 'p':
					printf("\n \t Registro de usuario tipo Proveedor\n\n");
					fprintf(archivo,"\n");
					fprintf(archivo,"P");
					printf("\n Ingrese el ID de tarjeta: ");
					fprintf(archivo," ");
